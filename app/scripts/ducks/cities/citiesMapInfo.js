...
const initialState = {
	data: {
		coordinates: [
			{ lat: 43.443579, lng: 39.910369, slug: "adler", name: "Адлер", category: ["курортный", "теплый климат"] },
			{ lat: 44.894965, lng: 37.31617, slug: "anapa", name: "Анапа", category: ["курортный", "теплый климат"] },
			{
				lat: 53.355084,
				lng: 83.769948,
				slug: "barnaul",
			...
			{ lat: 56.852593, lng: 53.204843, slug: "izhevsk", name: "Ижевск", category: ["больше 500 тысяч"] },
			{
				lat: 55.796289,
				lng: 49.108795,
				slug: "kazan",
			...
			{ lat: 54.70739, lng: 20.507307, slug: "kaliningrad", name: "Калининград", category: ["западная россия"] },
			{
				lat: 58.603581,
				lng: 49.667978,
				slug: "kirov",
			...
			{ lat: 44.723912, lng: 37.768974, slug: "novorossijsk", name: "Новороссийск", category: ["теплый климат"] },
			{
				lat: 55.030199,
				lng: 82.92043,
				slug: "novosibirsk",
			...
			{ lat: 43.585525, lng: 39.723062, slug: "sochi", name: "Сочи", category: ["курортный", "теплый климат"] },
			{ lat: 56.48464, lng: 84.947649, slug: "tomsk", name: "Томск", category: ["больше 500 тысяч"] },
			{ lat: 44.09564, lng: 39.073553, slug: "tuapse", name: "Туапсе", category: ["курортный", "теплый климат"] },
			{
				lat: 57.153033,
				lng: 65.534328,
				slug: "tumen",
			...
			{ lat: 56.146277, lng: 47.251079, slug: "cheboksary", name: "Чебоксары", category: ["недорогое жилье"] },
			{ lat: 55.159897, lng: 61.402554, slug: "chelyabinsk", name: "Челябинск", category: ["милионник"] },
			{ lat: 62.028103, lng: 129.732663, slug: "yakutsk", name: "Якутск", category: ["высокие зарплаты"] },
			{ lat: 44.498231, lng: 34.169317, slug: "yalta", name: "Ялта", category: ["курортный", "теплый климат"] },
			{
				lat: 57.626569,
				lng: 39.893787,
				slug: "yaroslavl",
		...
		[setCitiesMapInfo]: (state, { payload }) => {
			...
			const result = data.map(item => {
				...
				let arr = {
					...
					name: item.gorod,
					category: item.category.toLowerCase().split(", "),
					description: item.description === "" ? "Северный город на границе с Европой" : item.description,
					ratings: [
						{
							title: "Экология",
					...
					options: [
						{ title: "Климат", value: item.klimat },
						{
							title: "Метро",
							value: item.metro ? item.metro : "Нет"
						},
						{
							title: "ТЦ Мега",
							value: item.mega ? item.mega : "Нет"
						},
						{
							title: "Новостройки от",
